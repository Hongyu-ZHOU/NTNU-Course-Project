...
MODEL                = heli_q8_2_2
MODULES              = heli_q8_2_2_data.c heli_q8_2_2_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = heli_q8_2_2.mk
...
MODELLIB                  = heli_q8_2_2lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = heli_q8_2_2_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = C:\Users\fanga\DOCUME~1\MATLAB\HELICO~2
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\heli_q8_2_2_quarc_win64
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\fanga\Documents\MATLAB\Helicopter\Matlab
