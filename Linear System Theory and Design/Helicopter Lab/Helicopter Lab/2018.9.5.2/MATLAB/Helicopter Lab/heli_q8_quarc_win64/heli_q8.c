 ...
 * C source code generated on : Wed Sep 05 13:01:44 2018
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Sum: '<S5>/Subtract'
     */
    heli_q8_B.Gain_n = (heli_q8_P.Constant1_Value - heli_q8_P.Gain2_Gain *
                        heli_q8_B.Gain) * heli_q8_P.Gain_Gain_o;
  }
   ...
   *  Gain: '<S5>/Gain1'
   */
  rtb_Backgain = heli_q8_B.Gain_n - heli_q8_P.Gain1_Gain * heli_q8_B.Gain_b *
    heli_q8_P.Gain1_Gain_l;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (heli_q8_B.Constant - rtb_Backgain) * heli_q8_P.Backgain_Gain;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (1354665941U);
  heli_q8_M->Sizes.checksums[1] = (1438805410U);
  heli_q8_M->Sizes.checksums[2] = (3538319499U);
  heli_q8_M->Sizes.checksums[3] = (2039920605U);
