  ...
  ;%***********************
    ...
    ;%
    ;% Auto data (heli_q8_4_2_output_openloop_P)
    ;%
      section.nData     = 25;
      section.data(25)  = dumData; %prealloc
      
	  ;% heli_q8_4_2_output_openloop_P.A_0
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_4_2_output_openloop_P.B_0
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 36;
	
	  ;% heli_q8_4_2_output_openloop_P.C_0
	  ...
	  ;% heli_q8_4_2_output_openloop_P.K
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 68;
	
	  ;% heli_q8_4_2_output_openloop_P.L
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 78;
	
	  ;% heli_q8_4_2_output_openloop_P.P
	  ...
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_other_outputs
	  section.data(20).logicalSrcIdx = 19;
	  section.data(20).dtTransOffset = 111;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_other_outpu_m
	  section.data(21).logicalSrcIdx = 20;
	  section.data(21).dtTransOffset = 112;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_other_outpu_k
	  section.data(22).logicalSrcIdx = 21;
	  section.data(22).dtTransOffset = 113;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_other_outpu_j
	  ...
	  ;% heli_q8_4_2_output_openloop_P.HILReadEncoderTimebase_clock
	  section.data(1).logicalSrcIdx = 25;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_hardware_clocks
	  ...
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_watchdog_digital_
	  ...
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_analog_input_chan
	  ...
	  ;% heli_q8_4_2_output_openloop_P.HILReadEncoderTimebase_channels
	  section.data(3).logicalSrcIdx = 35;
	  section.data(3).dtTransOffset = 16;
	
	  ;% heli_q8_4_2_output_openloop_P.HILWriteAnalog_channels
	  section.data(4).logicalSrcIdx = 36;
	  section.data(4).dtTransOffset = 19;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_encoder_channels
	  ...
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_active
	  section.data(1).logicalSrcIdx = 41;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_final_digital_out
	  section.data(2).logicalSrcIdx = 42;
	  section.data(2).dtTransOffset = 1;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_initial_digital_o
	  section.data(3).logicalSrcIdx = 43;
	  section.data(3).dtTransOffset = 2;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_analog_input_
	  ...
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_analog_output
	  ...
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_analog_outp_e
	  ...
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_analog_out_ex
	  section.data(11).logicalSrcIdx = 51;
	  section.data(11).dtTransOffset = 10;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_analog_outp_p
	  section.data(12).logicalSrcIdx = 52;
	  section.data(12).dtTransOffset = 11;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_clock_frequen
	  section.data(13).logicalSrcIdx = 53;
	  section.data(13).dtTransOffset = 12;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_clock_frequ_e
	  section.data(14).logicalSrcIdx = 54;
	  section.data(14).dtTransOffset = 13;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_clock_params_
	  section.data(15).logicalSrcIdx = 55;
	  section.data(15).dtTransOffset = 14;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_clock_param_c
	  section.data(16).logicalSrcIdx = 56;
	  section.data(16).dtTransOffset = 15;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_digital_outpu
	  section.data(17).logicalSrcIdx = 57;
	  section.data(17).dtTransOffset = 16;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_digital_out_b
	  section.data(18).logicalSrcIdx = 58;
	  section.data(18).dtTransOffset = 17;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_digital_out_c
	  section.data(19).logicalSrcIdx = 59;
	  section.data(19).dtTransOffset = 18;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_digital_ou_c1
	  section.data(20).logicalSrcIdx = 60;
	  section.data(20).dtTransOffset = 19;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_digital_out_a
	  section.data(21).logicalSrcIdx = 61;
	  section.data(21).dtTransOffset = 20;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_digital_out_j
	  section.data(22).logicalSrcIdx = 62;
	  section.data(22).dtTransOffset = 21;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_digital_out_m
	  section.data(23).logicalSrcIdx = 63;
	  section.data(23).dtTransOffset = 22;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_encoder_count
	  ...
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_encoder_param
	  ...
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_other_outpu_l
	  section.data(28).logicalSrcIdx = 68;
	  section.data(28).dtTransOffset = 27;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_pwm_outputs_a
	  ...
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_pwm_output_ap
	  section.data(32).logicalSrcIdx = 72;
	  section.data(32).dtTransOffset = 31;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_pwm_outputs_o
	  section.data(33).logicalSrcIdx = 73;
	  section.data(33).dtTransOffset = 32;
	
	  ;% heli_q8_4_2_output_openloop_P.HILInitialize_set_pwm_params_at
	  ...
	  ;% heli_q8_4_2_output_openloop_P.Gain_Gain
	  ...
	  ;% heli_q8_4_2_output_openloop_P.Gain4_Gain
	  section.data(10).logicalSrcIdx = 85;
	  section.data(10).dtTransOffset = 9;
	
	  ;% heli_q8_4_2_output_openloop_P.ElevationCounttorad_Gain
	  ...
	  ;% heli_q8_4_2_output_openloop_P.Gain6_Gain
	  ...
	  ;% heli_q8_4_2_output_openloop_P.Gain7_Gain
	  ...
	  ;% heli_q8_4_2_output_openloop_P.Gainx_Gain
	  ...
	  ;% heli_q8_4_2_output_openloop_P.Gainy_Gain
	  ...
	  ;% heli_q8_4_2_output_openloop_P.GameController_BufferSize
	  ...
	  ;% heli_q8_4_2_output_openloop_P.HILReadEncoderTimebase_Active
	  section.data(1).logicalSrcIdx = 124;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_4_2_output_openloop_P.HILWriteAnalog_Active
	  section.data(2).logicalSrcIdx = 125;
	  section.data(2).dtTransOffset = 1;
	
	  ;% heli_q8_4_2_output_openloop_P.GameController_AutoCenter
	  section.data(3).logicalSrcIdx = 126;
	  section.data(3).dtTransOffset = 2;
	
	  ;% heli_q8_4_2_output_openloop_P.GameController_Enabled
  ...
  ;%**************************
    ...
    ;%
    ;% Auto data (heli_q8_4_2_output_openloop_B)
    ;%
      section.nData     = 30;
      section.data(30)  = dumData; %prealloc
      
	  ;% heli_q8_4_2_output_openloop_B.Integrator
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	  ...
	  ;% heli_q8_4_2_output_openloop_B.Gain4
	  section.data(6).logicalSrcIdx = 5;
	  ...
	  ;% heli_q8_4_2_output_openloop_B.Gain6
	  section.data(9).logicalSrcIdx = 8;
	  ...
	  ;% heli_q8_4_2_output_openloop_B.P
	  section.data(21).logicalSrcIdx = 20;
	  ...
	  ;% heli_q8_4_2_output_openloop_B.Sum_n
	  ...
	  ;% heli_q8_4_2_output_openloop_B.Sum_i
	  section.data(29).logicalSrcIdx = 28;
	  section.data(29).dtTransOffset = 39;
	
	  ;% heli_q8_4_2_output_openloop_B.Sum1_j
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (heli_q8_4_2_output_openloop_DW)
    ;%
      section.nData     = 11;
      section.data(11)  = dumData; %prealloc
      
	  ;% heli_q8_4_2_output_openloop_DW.HILInitialize_AIMinimums
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_4_2_output_openloop_DW.HILInitialize_AIMaximums
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 8;
	
	  ;% heli_q8_4_2_output_openloop_DW.HILInitialize_AOMinimums
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 16;
	
	  ;% heli_q8_4_2_output_openloop_DW.HILInitialize_AOMaximums
	  section.data(4).logicalSrcIdx = 3;
	  ...
	  ;% heli_q8_4_2_output_openloop_DW.HILInitialize_FilterFrequency
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 40;
	
	  ;% heli_q8_4_2_output_openloop_DW.HILInitialize_POSortedFreqs
	  section.data(7).logicalSrcIdx = 6;
	  ...
	  ;% heli_q8_4_2_output_openloop_DW.HILWriteAnalog_Buffer
	  section.data(11).logicalSrcIdx = 10;
	  ...
	  ;% heli_q8_4_2_output_openloop_DW.Scope_PWORK.LoggedData
	  section.data(1).logicalSrcIdx = 14;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_4_2_output_openloop_DW.ToWorkspace_PWORK.LoggedData
	  section.data(2).logicalSrcIdx = 15;
	  section.data(2).dtTransOffset = 1;
	
	  ;% heli_q8_4_2_output_openloop_DW.ToWorkspace1_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 16;
	  section.data(3).dtTransOffset = 2;
	
	  ;% heli_q8_4_2_output_openloop_DW.ToWorkspace2_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 17;
	  section.data(4).dtTransOffset = 3;
	
	  ;% heli_q8_4_2_output_openloop_DW.ToWorkspace3_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 18;
	  section.data(5).dtTransOffset = 4;
	
	  ;% heli_q8_4_2_output_openloop_DW.ToWorkspace4_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 19;
	  section.data(6).dtTransOffset = 5;
	
	  ;% heli_q8_4_2_output_openloop_DW.ToWorkspace5_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 20;
	  section.data(7).dtTransOffset = 6;
	
	  ;% heli_q8_4_2_output_openloop_DW.ElevationScopedegs_PWORK.LoggedData
	  section.data(8).logicalSrcIdx = 21;
	  section.data(8).dtTransOffset = 7;
	
	  ;% heli_q8_4_2_output_openloop_DW.ElevationScopedeg_PWORK.LoggedData
	  section.data(9).logicalSrcIdx = 22;
	  section.data(9).dtTransOffset = 8;
	
	  ;% heli_q8_4_2_output_openloop_DW.PitchScopedeg_PWORK.LoggedData
	  section.data(10).logicalSrcIdx = 23;
	  section.data(10).dtTransOffset = 9;
	
	  ;% heli_q8_4_2_output_openloop_DW.PtichrateScopedegs_PWORK.LoggedData
	  section.data(11).logicalSrcIdx = 24;
	  section.data(11).dtTransOffset = 10;
	
	  ;% heli_q8_4_2_output_openloop_DW.TravelrateScopedegs_PWORK.LoggedData
	  section.data(12).logicalSrcIdx = 25;
	  section.data(12).dtTransOffset = 11;
	
	  ;% heli_q8_4_2_output_openloop_DW.TravelScopedeg_PWORK.LoggedData
	  section.data(13).logicalSrcIdx = 26;
	  section.data(13).dtTransOffset = 12;
	
	  ;% heli_q8_4_2_output_openloop_DW.HILWriteAnalog_PWORK
	  section.data(14).logicalSrcIdx = 27;
	  section.data(14).dtTransOffset = 13;
	
	  ;% heli_q8_4_2_output_openloop_DW.Scope_PWORK_a.LoggedData
	  section.data(15).logicalSrcIdx = 28;
	  section.data(15).dtTransOffset = 14;
	
	  ;% heli_q8_4_2_output_openloop_DW.XScope_PWORK.LoggedData
	  section.data(16).logicalSrcIdx = 29;
	  section.data(16).dtTransOffset = 15;
	
	  ;% heli_q8_4_2_output_openloop_DW.YScope_PWORK.LoggedData
	  ...
	  ;% heli_q8_4_2_output_openloop_DW.HILInitialize_ClockModes
	  section.data(1).logicalSrcIdx = 31;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_4_2_output_openloop_DW.HILInitialize_QuadratureModes
	  section.data(2).logicalSrcIdx = 32;
	  section.data(2).dtTransOffset = 3;
	
	  ;% heli_q8_4_2_output_openloop_DW.HILInitialize_InitialEICounts
	  section.data(3).logicalSrcIdx = 33;
	  section.data(3).dtTransOffset = 11;
	
	  ;% heli_q8_4_2_output_openloop_DW.HILInitialize_POModeValues
	  section.data(4).logicalSrcIdx = 34;
	  section.data(4).dtTransOffset = 19;
	
	  ;% heli_q8_4_2_output_openloop_DW.HILInitialize_POAlignValues
	  section.data(5).logicalSrcIdx = 35;
	  section.data(5).dtTransOffset = 27;
	
	  ;% heli_q8_4_2_output_openloop_DW.HILInitialize_POPolarityVals
	  section.data(6).logicalSrcIdx = 36;
	  section.data(6).dtTransOffset = 35;
	
	  ;% heli_q8_4_2_output_openloop_DW.HILReadEncoderTimebase_Buffer
	  ...
	  ;% heli_q8_4_2_output_openloop_DW.HILInitialize_POSortedChans
  ...
  targMap.checksum0 = 36095233;
  targMap.checksum1 = 2257210748;
  targMap.checksum2 = 603967416;
  targMap.checksum3 = 157487746;
