 ...
 */
#ifndef RTW_HEADER_heli_q8_4_2_output_openloop_h_
#define RTW_HEADER_heli_q8_4_2_output_openloop_h_
#include <string.h>
#ifndef heli_q8_4_2_output_openloop_COMMON_INCLUDES_
# define heli_q8_4_2_output_openloop_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* heli_q8_4_2_output_openloop_COMMON_INCLUDES_ */

#include "heli_q8_4_2_output_openloop_types.h"
...
#define heli_q8_4_2_output_openloop_rtModel RT_MODEL_heli_q8_4_2_output_o_T
...
} DW_heli_q8_4_2_output_openloo_T;
...
} X_heli_q8_4_2_output_openloop_T;
...
typedef struct {
  ...
  real_T Integrator_CSTATE_j;          /* '<S4>/Integrator' */
  real_T Integrator1_CSTATE;           /* '<S4>/Integrator1' */
} XDot_heli_q8_4_2_output_openl_T;
...
} XDis_heli_q8_4_2_output_openl_T;
...
#define rtB                            heli_q8_4_2_output_openloop_B
#define BlockIO                        B_heli_q8_4_2_output_openloop_T
#define rtX                            heli_q8_4_2_output_openloop_X
#define ContinuousStates               X_heli_q8_4_2_output_openloop_T
#define rtXdot                         heli_q8_4_2_output_openloo_XDot
#define StateDerivatives               XDot_heli_q8_4_2_output_openl_T
#define tXdis                          heli_q8_4_2_output_openloo_XDis
#define StateDisabled                  XDis_heli_q8_4_2_output_openl_T
#define rtP                            heli_q8_4_2_output_openloop_P
#define Parameters                     P_heli_q8_4_2_output_openloop_T
#define rtDWork                        heli_q8_4_2_output_openloop_DW
#define D_Work                         DW_heli_q8_4_2_output_openloo_T

/* Parameters (auto storage) */
struct P_heli_q8_4_2_output_openloop_T_ {
  real_T A_0[36];                      /* Variable: A_0
                                        * Referenced by: '<S3>/A_0'
                                        */
  real_T B_0[12];                      /* Variable: B_0
                                        * Referenced by: '<S3>/B_0'
                                        */
  real_T C_0[18];                      /* Variable: C_0
                                        * Referenced by: '<S3>/C_0'
                                        */
  ...
  real_T Gain6_Gain;                   /* Expression: pi/180
                                        ...
                                        */
  real_T Constant1_Value_a;            /* Expression: 6.6
...
struct tag_RTM_heli_q8_4_2_output_op_T {
  const char_T *path;
...
extern P_heli_q8_4_2_output_openloop_T heli_q8_4_2_output_openloop_P;

/* Block signals (auto storage) */
extern B_heli_q8_4_2_output_openloop_T heli_q8_4_2_output_openloop_B;

/* Continuous states (auto storage) */
extern X_heli_q8_4_2_output_openloop_T heli_q8_4_2_output_openloop_X;

/* Block states (auto storage) */
extern DW_heli_q8_4_2_output_openloo_T heli_q8_4_2_output_openloop_DW;
...
extern void heli_q8_4_2_output_openloop_initialize(void);
extern void heli_q8_4_2_output_openloop_output0(void);
extern void heli_q8_4_2_output_openloop_update0(void);
extern void heli_q8_4_2_output_openloop_output(int_T tid);
extern void heli_q8_4_2_output_openloop_update(int_T tid);
extern void heli_q8_4_2_output_openloop_terminate(void);

/* Real-time Model object */
extern RT_MODEL_heli_q8_4_2_output_o_T *const heli_q8_4_2_output_openloop_M;
 ...
 *
 * '<Root>' : 'heli_q8_4_2_output_openloop'
 * '<S1>'   : 'heli_q8_4_2_output_openloop/Conversion'
 * '<S2>'   : 'heli_q8_4_2_output_openloop/Heli 3D'
 * '<S3>'   : 'heli_q8_4_2_output_openloop/Observor'
 * '<S4>'   : 'heli_q8_4_2_output_openloop/PI Controller'
 * '<S5>'   : 'heli_q8_4_2_output_openloop/Heli 3D/Elevation rad to deg'
 * '<S6>'   : 'heli_q8_4_2_output_openloop/Heli 3D/Elevation rate rad to deg'
 * '<S7>'   : 'heli_q8_4_2_output_openloop/Heli 3D/Pitch rad to deg'
 * '<S8>'   : 'heli_q8_4_2_output_openloop/Heli 3D/Pitch rate rad to deg'
 * '<S9>'   : 'heli_q8_4_2_output_openloop/Heli 3D/Travel rad to deg'
 * '<S10>'  : 'heli_q8_4_2_output_openloop/Heli 3D/Travel rate  rad to deg'
 * '<S11>'  : 'heli_q8_4_2_output_openloop/PI Controller/Joystick'
 */
#endif                                 /* RTW_HEADER_heli_q8_4_2_output_openloop_h_ */
