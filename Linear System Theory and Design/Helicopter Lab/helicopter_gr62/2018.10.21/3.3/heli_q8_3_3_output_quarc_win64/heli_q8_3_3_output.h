 ...
 */
#ifndef RTW_HEADER_heli_q8_3_3_output_h_
#define RTW_HEADER_heli_q8_3_3_output_h_
#include <string.h>
#ifndef heli_q8_3_3_output_COMMON_INCLUDES_
# define heli_q8_3_3_output_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* heli_q8_3_3_output_COMMON_INCLUDES_ */

#include "heli_q8_3_3_output_types.h"
...
#define heli_q8_3_3_output_rtModel     RT_MODEL_heli_q8_3_3_output_T
...
#define rtB                            heli_q8_3_3_output_B
#define BlockIO                        B_heli_q8_3_3_output_T
#define rtX                            heli_q8_3_3_output_X
#define ContinuousStates               X_heli_q8_3_3_output_T
#define rtXdot                         heli_q8_3_3_output_XDot
#define StateDerivatives               XDot_heli_q8_3_3_output_T
#define tXdis                          heli_q8_3_3_output_XDis
#define StateDisabled                  XDis_heli_q8_3_3_output_T
#define rtP                            heli_q8_3_3_output_P
#define Parameters                     P_heli_q8_3_3_output_T
#define rtDWork                        heli_q8_3_3_output_DW
#define D_Work                         DW_heli_q8_3_3_output_T

/* Parameters (auto storage) */
struct P_heli_q8_3_3_output_T_ {
...
struct tag_RTM_heli_q8_3_3_output_T {
  const char_T *path;
...
extern P_heli_q8_3_3_output_T heli_q8_3_3_output_P;

/* Block signals (auto storage) */
extern B_heli_q8_3_3_output_T heli_q8_3_3_output_B;

/* Continuous states (auto storage) */
extern X_heli_q8_3_3_output_T heli_q8_3_3_output_X;

/* Block states (auto storage) */
extern DW_heli_q8_3_3_output_T heli_q8_3_3_output_DW;
...
extern void heli_q8_3_3_output_initialize(void);
extern void heli_q8_3_3_output_output0(void);
extern void heli_q8_3_3_output_update0(void);
extern void heli_q8_3_3_output_output(int_T tid);
extern void heli_q8_3_3_output_update(int_T tid);
extern void heli_q8_3_3_output_terminate(void);

/* Real-time Model object */
extern RT_MODEL_heli_q8_3_3_output_T *const heli_q8_3_3_output_M;
 ...
 *
 * '<Root>' : 'heli_q8_3_3_output'
 * '<S1>'   : 'heli_q8_3_3_output/Conversion'
 * '<S2>'   : 'heli_q8_3_3_output/Heli 3D'
 * '<S3>'   : 'heli_q8_3_3_output/Joystick'
 * '<S4>'   : 'heli_q8_3_3_output/Heli 3D/Elevation rad to deg'
 * '<S5>'   : 'heli_q8_3_3_output/Heli 3D/Elevation rate rad to deg'
 * '<S6>'   : 'heli_q8_3_3_output/Heli 3D/Pitch rad to deg'
 * '<S7>'   : 'heli_q8_3_3_output/Heli 3D/Pitch rate rad to deg'
 * '<S8>'   : 'heli_q8_3_3_output/Heli 3D/Travel rad to deg'
 * '<S9>'   : 'heli_q8_3_3_output/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_heli_q8_3_3_output_h_ */
