 ...
 */
#ifndef RTW_HEADER_heli_q8_4_3_closeloop_h_
#define RTW_HEADER_heli_q8_4_3_closeloop_h_
#include <string.h>
#ifndef heli_q8_4_3_closeloop_COMMON_INCLUDES_
# define heli_q8_4_3_closeloop_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* heli_q8_4_3_closeloop_COMMON_INCLUDES_ */

#include "heli_q8_4_3_closeloop_types.h"
...
#define heli_q8_4_3_closeloop_rtModel  RT_MODEL_heli_q8_4_3_closeloo_T
...
typedef struct {
  ...
  real_T RateTransitionx;              /* '<S14>/Rate Transition: x' */
  real_T Joystick_gain_x;              /* '<S14>/Joystick_gain_x' */
  real_T Gain2;                        /* '<S5>/Gain2' */
  real_T RateTransitiony;              /* '<S14>/Rate Transition: y' */
  real_T Joystick_gain_y;              /* '<S14>/Joystick_gain_y' */
  ...
  real_T Gain_n;                       /* '<S13>/Gain' */
  real_T FrontmotorSaturation;         /* '<S3>/Front motor: Saturation' */
  real_T BackmotorSaturation;          /* '<S3>/Back motor: Saturation' */
  real_T Sum_c[6];                     /* '<S4>/Sum' */
  real_T GameController_o4;            /* '<S14>/Game Controller' */
  real_T GameController_o5;            /* '<S14>/Game Controller' */
  real_T Sum_k;                        /* '<S5>/Sum' */
  real_T Sum1_b;                       /* '<S5>/Sum1' */
} B_heli_q8_4_3_closeloop_T;
...
typedef struct {
  ...
  real_T RateTransitionx_Buffer0;      /* '<S14>/Rate Transition: x' */
  real_T RateTransitiony_Buffer0;      /* '<S14>/Rate Transition: y' */
  real_T HILWriteAnalog_Buffer[2];     /* '<S3>/HIL Write Analog' */
  t_game_controller GameController_Controller;/* '<S14>/Game Controller' */
  ...
  struct {
    void *LoggedData;
  } XScope_PWORK;                      /* '<S14>/X: Scope' */

  struct {
    void *LoggedData;
  } YScope_PWORK;                      /* '<S14>/Y: Scope' */
...
#define rtB                            heli_q8_4_3_closeloop_B
#define BlockIO                        B_heli_q8_4_3_closeloop_T
#define rtX                            heli_q8_4_3_closeloop_X
#define ContinuousStates               X_heli_q8_4_3_closeloop_T
#define rtXdot                         heli_q8_4_3_closeloop_XDot
#define StateDerivatives               XDot_heli_q8_4_3_closeloop_T
#define tXdis                          heli_q8_4_3_closeloop_XDis
#define StateDisabled                  XDis_heli_q8_4_3_closeloop_T
#define rtP                            heli_q8_4_3_closeloop_P
#define Parameters                     P_heli_q8_4_3_closeloop_T
#define rtDWork                        heli_q8_4_3_closeloop_DW
#define D_Work                         DW_heli_q8_4_3_closeloop_T

/* Parameters (auto storage) */
struct P_heli_q8_4_3_closeloop_T_ {
  real_T A_0[36];                      /* Variable: A_0
                                        * Referenced by: '<S4>/A_0'
                                        */
  real_T B_0[12];                      /* Variable: B_0
  ...
  real_T HILInitialize_analog_input_maxi;/* Mask Parameter: HILInitialize_analog_input_maxi
                                          ...
                                          */
  real_T HILInitialize1_analog_input_max;/* Mask Parameter: HILInitialize1_analog_input_max
                                          * Referenced by: '<Root>/HIL Initialize1'
                                          */
  real_T HILInitialize_analog_input_mini;/* Mask Parameter: HILInitialize_analog_input_mini
                                          * Referenced by: '<Root>/HIL Initialize'
                                          */
  real_T HILInitialize1_analog_input_min;/* Mask Parameter: HILInitialize1_analog_input_min
                                          * Referenced by: '<Root>/HIL Initialize1'
                                          */
  real_T HILInitialize_analog_output_max;/* Mask Parameter: HILInitialize_analog_output_max
                                          * Referenced by: '<Root>/HIL Initialize'
                                          */
  real_T HILInitialize1_analog_output_ma;/* Mask Parameter: HILInitialize1_analog_output_ma
                                          * Referenced by: '<Root>/HIL Initialize1'
                                          */
  real_T HILInitialize_analog_output_min;/* Mask Parameter: HILInitialize_analog_output_min
                                          * Referenced by: '<Root>/HIL Initialize'
                                          */
  real_T HILInitialize1_analog_output_mi;/* Mask Parameter: HILInitialize1_analog_output_mi
                                          * Referenced by: '<Root>/HIL Initialize1'
                                          */
  ...
  real_T HILInitialize_initial_analog_ou;/* Mask Parameter: HILInitialize_initial_analog_ou
                                          * Referenced by: '<Root>/HIL Initialize'
                                          */
  real_T HILInitialize1_initial_analog_o;/* Mask Parameter: HILInitialize1_initial_analog_o
                                          * Referenced by: '<Root>/HIL Initialize1'
                                          */
  real_T HILInitialize_initial_pwm_outpu;/* Mask Parameter: HILInitialize_initial_pwm_outpu
                                          * Referenced by: '<Root>/HIL Initialize'
                                          */
  real_T HILInitialize1_initial_pwm_outp;/* Mask Parameter: HILInitialize1_initial_pwm_outp
                                          * Referenced by: '<Root>/HIL Initialize1'
                                          */
  real_T HILInitialize_pwm_frequency;  /* Mask Parameter: HILInitialize_pwm_frequency
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  real_T HILInitialize1_pwm_frequency; /* Mask Parameter: HILInitialize1_pwm_frequency
                                        * Referenced by: '<Root>/HIL Initialize1'
                                        */
  real_T HILInitialize_pwm_leading_deadb;/* Mask Parameter: HILInitialize_pwm_leading_deadb
                                          * Referenced by: '<Root>/HIL Initialize'
                                          */
  real_T HILInitialize1_pwm_leading_dead;/* Mask Parameter: HILInitialize1_pwm_leading_dead
                                          * Referenced by: '<Root>/HIL Initialize1'
                                          */
  real_T HILInitialize_pwm_trailing_dead;/* Mask Parameter: HILInitialize_pwm_trailing_dead
                                          * Referenced by: '<Root>/HIL Initialize'
                                          */
  real_T HILInitialize1_pwm_trailing_dea;/* Mask Parameter: HILInitialize1_pwm_trailing_dea
                                          * Referenced by: '<Root>/HIL Initialize1'
                                          */
  ...
  real_T HILInitialize_set_other_outpu_m;/* Mask Parameter: HILInitialize_set_other_outpu_m
                                          * Referenced by: '<Root>/HIL Initialize'
                                          */
  real_T HILInitialize1_set_other_outp_d;/* Mask Parameter: HILInitialize1_set_other_outp_d
                                          * Referenced by: '<Root>/HIL Initialize1'
                                          */
  real_T HILInitialize_set_other_outpu_k;/* Mask Parameter: HILInitialize_set_other_outpu_k
                                          * Referenced by: '<Root>/HIL Initialize'
                                          */
  real_T HILInitialize1_set_other_outp_h;/* Mask Parameter: HILInitialize1_set_other_outp_h
                                          * Referenced by: '<Root>/HIL Initialize1'
                                          */
  real_T HILInitialize_set_other_outpu_j;/* Mask Parameter: HILInitialize_set_other_outpu_j
                                          * Referenced by: '<Root>/HIL Initialize'
                                          */
  real_T HILInitialize1_set_other_outp_g;/* Mask Parameter: HILInitialize1_set_other_outp_g
                                          * Referenced by: '<Root>/HIL Initialize1'
                                          */
  real_T HILInitialize_watchdog_analog_o;/* Mask Parameter: HILInitialize_watchdog_analog_o
                                          * Referenced by: '<Root>/HIL Initialize'
                                          */
  real_T HILInitialize1_watchdog_analog_;/* Mask Parameter: HILInitialize1_watchdog_analog_
                                          * Referenced by: '<Root>/HIL Initialize1'
                                          */
  real_T HILInitialize_watchdog_pwm_outp;/* Mask Parameter: HILInitialize_watchdog_pwm_outp
                                          * Referenced by: '<Root>/HIL Initialize'
                                          */
  real_T HILInitialize1_watchdog_pwm_out;/* Mask Parameter: HILInitialize1_watchdog_pwm_out
                                          * Referenced by: '<Root>/HIL Initialize1'
                                          */
  ...
  int32_T HILInitialize_hardware_clocks[3];/* Mask Parameter: HILInitialize_hardware_clocks
                                            * Referenced by: '<Root>/HIL Initialize'
                                            */
  int32_T HILInitialize1_hardware_clocks[3];/* Mask Parameter: HILInitialize1_hardware_clocks
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  int32_T HILInitialize_initial_encoder_c;/* Mask Parameter: HILInitialize_initial_encoder_c
                                           * Referenced by: '<Root>/HIL Initialize'
                                           */
  int32_T HILInitialize1_initial_encoder_;/* Mask Parameter: HILInitialize1_initial_encoder_
                                           * Referenced by: '<Root>/HIL Initialize1'
                                           */
  int32_T HILInitialize_pwm_alignment; /* Mask Parameter: HILInitialize_pwm_alignment
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  int32_T HILInitialize1_pwm_alignment;/* Mask Parameter: HILInitialize1_pwm_alignment
                                        * Referenced by: '<Root>/HIL Initialize1'
                                        */
  int32_T HILInitialize_pwm_configuration;/* Mask Parameter: HILInitialize_pwm_configuration
                                           * Referenced by: '<Root>/HIL Initialize'
                                           */
  int32_T HILInitialize1_pwm_configuratio;/* Mask Parameter: HILInitialize1_pwm_configuratio
                                           * Referenced by: '<Root>/HIL Initialize1'
                                           */
  int32_T HILInitialize_pwm_modes;     /* Mask Parameter: HILInitialize_pwm_modes
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  int32_T HILInitialize1_pwm_modes;    /* Mask Parameter: HILInitialize1_pwm_modes
                                        * Referenced by: '<Root>/HIL Initialize1'
                                        */
  int32_T HILInitialize_pwm_polarity;  /* Mask Parameter: HILInitialize_pwm_polarity
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  int32_T HILInitialize1_pwm_polarity; /* Mask Parameter: HILInitialize1_pwm_polarity
                                        * Referenced by: '<Root>/HIL Initialize1'
                                        */
  int32_T HILInitialize_watchdog_digital_;/* Mask Parameter: HILInitialize_watchdog_digital_
                                           * Referenced by: '<Root>/HIL Initialize'
                                           */
  int32_T HILInitialize1_watchdog_digital;/* Mask Parameter: HILInitialize1_watchdog_digital
                                           * Referenced by: '<Root>/HIL Initialize1'
                                           */
  uint32_T HILInitialize_analog_input_chan[8];/* Mask Parameter: HILInitialize_analog_input_chan
                                               * Referenced by: '<Root>/HIL Initialize'
                                               */
  uint32_T HILInitialize1_analog_input_cha[8];/* Mask Parameter: HILInitialize1_analog_input_cha
                                               * Referenced by: '<Root>/HIL Initialize1'
                                               */
  uint32_T HILInitialize_analog_output_cha[8];/* Mask Parameter: HILInitialize_analog_output_cha
                                               * Referenced by: '<Root>/HIL Initialize'
                                               */
  uint32_T HILInitialize1_analog_output_ch[8];/* Mask Parameter: HILInitialize1_analog_output_ch
                                               * Referenced by: '<Root>/HIL Initialize1'
                                               */
  ...
  uint32_T HILInitialize_encoder_channels[8];/* Mask Parameter: HILInitialize_encoder_channels
                                              * Referenced by: '<Root>/HIL Initialize'
                                              */
  uint32_T HILInitialize1_encoder_channels[8];/* Mask Parameter: HILInitialize1_encoder_channels
                                               * Referenced by: '<Root>/HIL Initialize1'
                                               */
  uint32_T HILInitialize_pwm_channels[8];/* Mask Parameter: HILInitialize_pwm_channels
                                          * Referenced by: '<Root>/HIL Initialize'
                                          */
  uint32_T HILInitialize1_pwm_channels[8];/* Mask Parameter: HILInitialize1_pwm_channels
                                           * Referenced by: '<Root>/HIL Initialize1'
                                           */
  uint32_T HILInitialize_quadrature;   /* Mask Parameter: HILInitialize_quadrature
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  uint32_T HILInitialize1_quadrature;  /* Mask Parameter: HILInitialize1_quadrature
                                        * Referenced by: '<Root>/HIL Initialize1'
                                        */
  ...
  boolean_T HILInitialize_initial_digital_o;/* Mask Parameter: HILInitialize_initial_digital_o
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_initial_digital_;/* Mask Parameter: HILInitialize1_initial_digital_
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_analog_input_;/* Mask Parameter: HILInitialize_set_analog_input_
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_analog_input;/* Mask Parameter: HILInitialize1_set_analog_input
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_analog_inpu_m;/* Mask Parameter: HILInitialize_set_analog_inpu_m
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_analog_inp_f;/* Mask Parameter: HILInitialize1_set_analog_inp_f
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  ...
  boolean_T HILInitialize_set_analog_outp_b;/* Mask Parameter: HILInitialize_set_analog_outp_b
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_analog_out_o;/* Mask Parameter: HILInitialize1_set_analog_out_o
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_analog_outp_e;/* Mask Parameter: HILInitialize_set_analog_outp_e
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_analog_out_n;/* Mask Parameter: HILInitialize1_set_analog_out_n
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_analog_outp_j;/* Mask Parameter: HILInitialize_set_analog_outp_j
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_analog_out_p;/* Mask Parameter: HILInitialize1_set_analog_out_p
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_analog_outp_c;/* Mask Parameter: HILInitialize_set_analog_outp_c
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_analog_ou_oi;/* Mask Parameter: HILInitialize1_set_analog_ou_oi
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_analog_out_ex;/* Mask Parameter: HILInitialize_set_analog_out_ex
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_analog_out_l;/* Mask Parameter: HILInitialize1_set_analog_out_l
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  ...
  boolean_T HILInitialize_set_clock_frequen;/* Mask Parameter: HILInitialize_set_clock_frequen
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_clock_freque;/* Mask Parameter: HILInitialize1_set_clock_freque
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_clock_frequ_e;/* Mask Parameter: HILInitialize_set_clock_frequ_e
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_clock_freq_j;/* Mask Parameter: HILInitialize1_set_clock_freq_j
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_clock_params_;/* Mask Parameter: HILInitialize_set_clock_params_
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_clock_params;/* Mask Parameter: HILInitialize1_set_clock_params
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_clock_param_c;/* Mask Parameter: HILInitialize_set_clock_param_c
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_clock_para_b;/* Mask Parameter: HILInitialize1_set_clock_para_b
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  ...
  boolean_T HILInitialize_set_digital_out_b;/* Mask Parameter: HILInitialize_set_digital_out_b
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_digital_ou_a;/* Mask Parameter: HILInitialize1_set_digital_ou_a
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_digital_out_c;/* Mask Parameter: HILInitialize_set_digital_out_c
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_digital_o_ah;/* Mask Parameter: HILInitialize1_set_digital_o_ah
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_digital_ou_c1;/* Mask Parameter: HILInitialize_set_digital_ou_c1
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_digital_ou_m;/* Mask Parameter: HILInitialize1_set_digital_ou_m
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_digital_out_a;/* Mask Parameter: HILInitialize_set_digital_out_a
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_digital_ou_o;/* Mask Parameter: HILInitialize1_set_digital_ou_o
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_digital_out_j;/* Mask Parameter: HILInitialize_set_digital_out_j
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_digital_ou_k;/* Mask Parameter: HILInitialize1_set_digital_ou_k
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_digital_out_m;/* Mask Parameter: HILInitialize_set_digital_out_m
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_digital_o_oo;/* Mask Parameter: HILInitialize1_set_digital_o_oo
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_encoder_count;/* Mask Parameter: HILInitialize_set_encoder_count
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_encoder_coun;/* Mask Parameter: HILInitialize1_set_encoder_coun
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_encoder_cou_k;/* Mask Parameter: HILInitialize_set_encoder_cou_k
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_encoder_co_h;/* Mask Parameter: HILInitialize1_set_encoder_co_h
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_encoder_param;/* Mask Parameter: HILInitialize_set_encoder_param
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_encoder_para;/* Mask Parameter: HILInitialize1_set_encoder_para
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_encoder_par_m;/* Mask Parameter: HILInitialize_set_encoder_par_m
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_encoder_pa_e;/* Mask Parameter: HILInitialize1_set_encoder_pa_e
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_other_outpu_l;/* Mask Parameter: HILInitialize_set_other_outpu_l
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_other_outp_c;/* Mask Parameter: HILInitialize1_set_other_outp_c
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  ...
  boolean_T HILInitialize_set_pwm_outputs_g;/* Mask Parameter: HILInitialize_set_pwm_outputs_g
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_pwm_output_a;/* Mask Parameter: HILInitialize1_set_pwm_output_a
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_pwm_outputs_p;/* Mask Parameter: HILInitialize_set_pwm_outputs_p
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_pwm_output_j;/* Mask Parameter: HILInitialize1_set_pwm_output_j
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_pwm_output_ap;/* Mask Parameter: HILInitialize_set_pwm_output_ap
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_pwm_output_f;/* Mask Parameter: HILInitialize1_set_pwm_output_f
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_pwm_outputs_o;/* Mask Parameter: HILInitialize_set_pwm_outputs_o
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_pwm_output_c;/* Mask Parameter: HILInitialize1_set_pwm_output_c
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_pwm_params_at;/* Mask Parameter: HILInitialize_set_pwm_params_at
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_pwm_params_a;/* Mask Parameter: HILInitialize1_set_pwm_params_a
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  boolean_T HILInitialize_set_pwm_params__f;/* Mask Parameter: HILInitialize_set_pwm_params__f
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize1_set_pwm_params_f;/* Mask Parameter: HILInitialize1_set_pwm_params_f
                                             * Referenced by: '<Root>/HIL Initialize1'
                                             */
  ...
  real_T Gain6_Gain;                   /* Expression: pi/180
                                        ...
                                        */
  real_T Constant_Value;               /* Expression: 6.6
  ...
  real_T Gain_Gain_e;                  /* Expression: 180/pi
                                        ...
                                        */
  real_T Constant_Value_j;             /* Expression: -30
...
struct tag_RTM_heli_q8_4_3_closeloop_T {
  const char_T *path;
...
extern P_heli_q8_4_3_closeloop_T heli_q8_4_3_closeloop_P;

/* Block signals (auto storage) */
extern B_heli_q8_4_3_closeloop_T heli_q8_4_3_closeloop_B;

/* Continuous states (auto storage) */
extern X_heli_q8_4_3_closeloop_T heli_q8_4_3_closeloop_X;

/* Block states (auto storage) */
extern DW_heli_q8_4_3_closeloop_T heli_q8_4_3_closeloop_DW;
...
extern void heli_q8_4_3_closeloop_initialize(void);
extern void heli_q8_4_3_closeloop_output0(void);
extern void heli_q8_4_3_closeloop_update0(void);
extern void heli_q8_4_3_closeloop_output(int_T tid);
extern void heli_q8_4_3_closeloop_update(int_T tid);
extern void heli_q8_4_3_closeloop_terminate(void);

/* Real-time Model object */
extern RT_MODEL_heli_q8_4_3_closeloo_T *const heli_q8_4_3_closeloop_M;
 ...
 *
 * '<Root>' : 'heli_q8_4_3_closeloop'
 * '<S1>'   : 'heli_q8_4_3_closeloop/Conversion'
 * '<S2>'   : 'heli_q8_4_3_closeloop/Elevation controller'
 * '<S3>'   : 'heli_q8_4_3_closeloop/Heli 3D'
 * '<S4>'   : 'heli_q8_4_3_closeloop/Observor'
 * '<S5>'   : 'heli_q8_4_3_closeloop/PI Controller'
 * '<S6>'   : 'heli_q8_4_3_closeloop/Pitch controller'
 * '<S7>'   : 'heli_q8_4_3_closeloop/Elevation controller/Elevation controller'
 * '<S8>'   : 'heli_q8_4_3_closeloop/Heli 3D/Elevation rad to deg'
 * '<S9>'   : 'heli_q8_4_3_closeloop/Heli 3D/Elevation rate rad to deg'
 * '<S10>'  : 'heli_q8_4_3_closeloop/Heli 3D/Pitch rad to deg'
 * '<S11>'  : 'heli_q8_4_3_closeloop/Heli 3D/Pitch rate rad to deg'
 * '<S12>'  : 'heli_q8_4_3_closeloop/Heli 3D/Travel rad to deg'
 * '<S13>'  : 'heli_q8_4_3_closeloop/Heli 3D/Travel rate  rad to deg'
 * '<S14>'  : 'heli_q8_4_3_closeloop/PI Controller/Joystick'
 */
#endif                                 /* RTW_HEADER_heli_q8_4_3_closeloop_h_ */
