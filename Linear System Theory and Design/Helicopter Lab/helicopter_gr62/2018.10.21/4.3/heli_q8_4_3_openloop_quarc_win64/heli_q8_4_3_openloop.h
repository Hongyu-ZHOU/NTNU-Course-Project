 ...
 */
#ifndef RTW_HEADER_heli_q8_4_3_openloop_h_
#define RTW_HEADER_heli_q8_4_3_openloop_h_
#include <string.h>
#ifndef heli_q8_4_3_openloop_COMMON_INCLUDES_
# define heli_q8_4_3_openloop_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* heli_q8_4_3_openloop_COMMON_INCLUDES_ */

#include "heli_q8_4_3_openloop_types.h"
...
#define heli_q8_4_3_openloop_rtModel   RT_MODEL_heli_q8_4_3_openloop_T
...
typedef struct {
  ...
  real_T Sum_g[6];                     /* '<S5>/Sum' */
  real_T Sum_n;                        /* '<Root>/Sum' */
  real_T Sum1_j;                       /* '<Root>/Sum1' */
} B_heli_q8_4_3_openloop_T;
...
#define rtB                            heli_q8_4_3_openloop_B
#define BlockIO                        B_heli_q8_4_3_openloop_T
#define rtX                            heli_q8_4_3_openloop_X
#define ContinuousStates               X_heli_q8_4_3_openloop_T
#define rtXdot                         heli_q8_4_3_openloop_XDot
#define StateDerivatives               XDot_heli_q8_4_3_openloop_T
#define tXdis                          heli_q8_4_3_openloop_XDis
#define StateDisabled                  XDis_heli_q8_4_3_openloop_T
#define rtP                            heli_q8_4_3_openloop_P
#define Parameters                     P_heli_q8_4_3_openloop_T
#define rtDWork                        heli_q8_4_3_openloop_DW
#define D_Work                         DW_heli_q8_4_3_openloop_T

/* Parameters (auto storage) */
struct P_heli_q8_4_3_openloop_T_ {
  ...
  real_T Gain_Gain_ar;                 /* Expression: 180/pi
                                        ...
                                        */
  real_T Constant_Value_d;             /* Expression: 6.6
...
struct tag_RTM_heli_q8_4_3_openloop_T {
  const char_T *path;
...
extern P_heli_q8_4_3_openloop_T heli_q8_4_3_openloop_P;

/* Block signals (auto storage) */
extern B_heli_q8_4_3_openloop_T heli_q8_4_3_openloop_B;

/* Continuous states (auto storage) */
extern X_heli_q8_4_3_openloop_T heli_q8_4_3_openloop_X;

/* Block states (auto storage) */
extern DW_heli_q8_4_3_openloop_T heli_q8_4_3_openloop_DW;
...
extern void heli_q8_4_3_openloop_initialize(void);
extern void heli_q8_4_3_openloop_output0(void);
extern void heli_q8_4_3_openloop_update0(void);
extern void heli_q8_4_3_openloop_output(int_T tid);
extern void heli_q8_4_3_openloop_update(int_T tid);
extern void heli_q8_4_3_openloop_terminate(void);

/* Real-time Model object */
extern RT_MODEL_heli_q8_4_3_openloop_T *const heli_q8_4_3_openloop_M;
 ...
 *
 * '<Root>' : 'heli_q8_4_3_openloop'
 * '<S1>'   : 'heli_q8_4_3_openloop/Conversion'
 * '<S2>'   : 'heli_q8_4_3_openloop/Elevation controller'
 * '<S3>'   : 'heli_q8_4_3_openloop/Heli 3D'
 * '<S4>'   : 'heli_q8_4_3_openloop/Joystick'
 * '<S5>'   : 'heli_q8_4_3_openloop/Observor'
 * '<S6>'   : 'heli_q8_4_3_openloop/Pitch controller'
 * '<S7>'   : 'heli_q8_4_3_openloop/Elevation controller/Elevation controller'
 * '<S8>'   : 'heli_q8_4_3_openloop/Heli 3D/Elevation rad to deg'
 * '<S9>'   : 'heli_q8_4_3_openloop/Heli 3D/Elevation rate rad to deg'
 * '<S10>'  : 'heli_q8_4_3_openloop/Heli 3D/Pitch rad to deg'
 * '<S11>'  : 'heli_q8_4_3_openloop/Heli 3D/Pitch rate rad to deg'
 * '<S12>'  : 'heli_q8_4_3_openloop/Heli 3D/Travel rad to deg'
 * '<S13>'  : 'heli_q8_4_3_openloop/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_heli_q8_4_3_openloop_h_ */
