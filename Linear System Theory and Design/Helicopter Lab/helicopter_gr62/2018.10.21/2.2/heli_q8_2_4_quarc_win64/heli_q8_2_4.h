 ...
 */
#ifndef RTW_HEADER_heli_q8_2_4_h_
#define RTW_HEADER_heli_q8_2_4_h_
#include <string.h>
#ifndef heli_q8_2_4_COMMON_INCLUDES_
# define heli_q8_2_4_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* heli_q8_2_4_COMMON_INCLUDES_ */

#include "heli_q8_2_4_types.h"
...
#define heli_q8_2_4_rtModel            RT_MODEL_heli_q8_2_4_T
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } JoystickXinput_PWORK;              /* '<Root>/Joystick X input' */
...
#define rtB                            heli_q8_2_4_B
#define BlockIO                        B_heli_q8_2_4_T
#define rtX                            heli_q8_2_4_X
#define ContinuousStates               X_heli_q8_2_4_T
#define rtXdot                         heli_q8_2_4_XDot
#define StateDerivatives               XDot_heli_q8_2_4_T
#define tXdis                          heli_q8_2_4_XDis
#define StateDisabled                  XDis_heli_q8_2_4_T
#define rtP                            heli_q8_2_4_P
#define Parameters                     P_heli_q8_2_4_T
#define rtDWork                        heli_q8_2_4_DW
#define D_Work                         DW_heli_q8_2_4_T

/* Parameters (auto storage) */
struct P_heli_q8_2_4_T_ {
...
extern P_heli_q8_2_4_T heli_q8_2_4_P;

/* Block signals (auto storage) */
extern B_heli_q8_2_4_T heli_q8_2_4_B;

/* Continuous states (auto storage) */
extern X_heli_q8_2_4_T heli_q8_2_4_X;

/* Block states (auto storage) */
extern DW_heli_q8_2_4_T heli_q8_2_4_DW;
...
extern void heli_q8_2_4_initialize(void);
extern void heli_q8_2_4_output0(void);
extern void heli_q8_2_4_update0(void);
extern void heli_q8_2_4_output(int_T tid);
extern void heli_q8_2_4_update(int_T tid);
extern void heli_q8_2_4_terminate(void);

/* Real-time Model object */
extern RT_MODEL_heli_q8_2_4_T *const heli_q8_2_4_M;
 ...
 *
 * '<Root>' : 'heli_q8_2_4'
 * '<S1>'   : 'heli_q8_2_4/Conversion'
 * '<S2>'   : 'heli_q8_2_4/Elevation controller'
 * '<S3>'   : 'heli_q8_2_4/Heli 3D'
 * '<S4>'   : 'heli_q8_2_4/Joystick'
 * '<S5>'   : 'heli_q8_2_4/Pitch controller'
 * '<S6>'   : 'heli_q8_2_4/Elevation controller/Elevation controller'
 * '<S7>'   : 'heli_q8_2_4/Heli 3D/Elevation rad to deg'
 * '<S8>'   : 'heli_q8_2_4/Heli 3D/Elevation rate rad to deg'
 * '<S9>'   : 'heli_q8_2_4/Heli 3D/Pitch rad to deg'
 * '<S10>'  : 'heli_q8_2_4/Heli 3D/Pitch rate rad to deg'
 * '<S11>'  : 'heli_q8_2_4/Heli 3D/Travel rad to deg'
 * '<S12>'  : 'heli_q8_2_4/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_heli_q8_2_4_h_ */
