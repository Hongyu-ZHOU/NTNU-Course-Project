 ...
 */
#ifndef RTW_HEADER_heli_q8_2_2_h_
#define RTW_HEADER_heli_q8_2_2_h_
#include <string.h>
#ifndef heli_q8_2_2_COMMON_INCLUDES_
# define heli_q8_2_2_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* heli_q8_2_2_COMMON_INCLUDES_ */

#include "heli_q8_2_2_types.h"
...
#define heli_q8_2_2_rtModel            RT_MODEL_heli_q8_2_2_T
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } JoystickXoutput_PWORK;             /* '<Root>/Joystick X output' */

  struct {
    void *LoggedData;
  } Travelrateoutput_PWORK;            /* '<Root>/Travel rate output ' */
...
#define rtB                            heli_q8_2_2_B
#define BlockIO                        B_heli_q8_2_2_T
#define rtX                            heli_q8_2_2_X
#define ContinuousStates               X_heli_q8_2_2_T
#define rtXdot                         heli_q8_2_2_XDot
#define StateDerivatives               XDot_heli_q8_2_2_T
#define tXdis                          heli_q8_2_2_XDis
#define StateDisabled                  XDis_heli_q8_2_2_T
#define rtP                            heli_q8_2_2_P
#define Parameters                     P_heli_q8_2_2_T
#define rtDWork                        heli_q8_2_2_DW
#define D_Work                         DW_heli_q8_2_2_T

/* Parameters (auto storage) */
struct P_heli_q8_2_2_T_ {
  ...
  real_T Gain_Gain_l;                  /* Expression: 180/pi
                                        ...
                                        */
  real_T Constant_Value_j;             /* Expression: -29.5
...
extern P_heli_q8_2_2_T heli_q8_2_2_P;

/* Block signals (auto storage) */
extern B_heli_q8_2_2_T heli_q8_2_2_B;

/* Continuous states (auto storage) */
extern X_heli_q8_2_2_T heli_q8_2_2_X;

/* Block states (auto storage) */
extern DW_heli_q8_2_2_T heli_q8_2_2_DW;
...
extern void heli_q8_2_2_initialize(void);
extern void heli_q8_2_2_output0(void);
extern void heli_q8_2_2_update0(void);
extern void heli_q8_2_2_output(int_T tid);
extern void heli_q8_2_2_update(int_T tid);
extern void heli_q8_2_2_terminate(void);

/* Real-time Model object */
extern RT_MODEL_heli_q8_2_2_T *const heli_q8_2_2_M;
 ...
 *
 * '<Root>' : 'heli_q8_2_2'
 * '<S1>'   : 'heli_q8_2_2/Conversion'
 * '<S2>'   : 'heli_q8_2_2/Elevation controller'
 * '<S3>'   : 'heli_q8_2_2/Heli 3D'
 * '<S4>'   : 'heli_q8_2_2/Joystick'
 * '<S5>'   : 'heli_q8_2_2/Pitch controller'
 * '<S6>'   : 'heli_q8_2_2/Elevation controller/Elevation controller'
 * '<S7>'   : 'heli_q8_2_2/Heli 3D/Elevation rad to deg'
 * '<S8>'   : 'heli_q8_2_2/Heli 3D/Elevation rate rad to deg'
 * '<S9>'   : 'heli_q8_2_2/Heli 3D/Pitch rad to deg'
 * '<S10>'  : 'heli_q8_2_2/Heli 3D/Pitch rate rad to deg'
 * '<S11>'  : 'heli_q8_2_2/Heli 3D/Travel rad to deg'
 * '<S12>'  : 'heli_q8_2_2/Heli 3D/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_heli_q8_2_2_h_ */
